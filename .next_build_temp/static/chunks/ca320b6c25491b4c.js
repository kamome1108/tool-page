...
to {
  ...
  animation: ${K} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,V=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(q,null,t):t:"blank"===r?null:s.createElement(U,null,s.createElement(F,{...a}),"loading"!==r&&s.createElement(R,null,"error"===r?s.createElement(M,{...a}):s.createElement(B,{...a})))},W=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
