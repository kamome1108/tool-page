...
to {
  ...
  animation: ${q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,V=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(K,null,t):t:"blank"===r?null:s.createElement(H,null,s.createElement(M,{...a}),"loading"!==r&&s.createElement(F,null,"error"===r?s.createElement(P,{...a}):s.createElement(_,{...a})))},W=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`];return{animation:t?`${h(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${h(s)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}})(e.position||t||"top-center",e.visible):{opacity:0},i=s.createElement(V,{toast:e}),n=s.createElement(Y,{...e.ariaProps},y(e.message,e));return s.createElement(W,{className:e.className,style:{...o,...r,...e.style}},"function"==typeof a?a({icon:i,message:n}):s.createElement(s.Fragment,null,i,n))});a=s.createElement,d.p=void 0,m=a,f=void 0,g=void 0;var G=({id:e,className:t,style:r,onHeightUpdate:a,children:o})=>{let i=s.useCallback(t=>{if(t){let r=()=>{a(e,t.getBoundingClientRect().height)};r(),new MutationObserver(r).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,a]);return s.createElement("div",{ref:i,className:t,style:r},o)},J=p`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Q=({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:a,children:o,toasterId:i,containerStyle:n,containerClassName:l})=>{let{toasts:d,handlers:c}=((e,t="default")=>{let{toasts:r,pausedAt:a}=((e={},t=w)=>{let[r,a]=(0,s.useState)(C[t]||k),o=(0,s.useRef)(C[t]);(0,s.useEffect)(()=>(o.current!==C[t]&&a(C[t]),N.push([t,a]),()=>{let e=N.findIndex(([e])=>e===t);e>-1&&N.splice(e,1)}),[t]);let i=r.toasts.map(t=>{var r,a,s;return{...e,...e[t.type],...t,removeDelay:t.removeDelay||(null==(r=e[t.type])?void 0:r.removeDelay)||(null==e?void 0:e.removeDelay),duration:t.duration||(null==(a=e[t.type])?void 0:a.duration)||(null==e?void 0:e.duration)||D[t.type],style:{...e.style,...null==(s=e[t.type])?void 0:s.style,...t.style}}});return{...r,toasts:i}})(e,t),o=(0,s.useRef)(new Map).current,i=(0,s.useCallback)((e,t=A)=>{if(o.has(e))return;let r=setTimeout(()=>{o.delete(e),n({type:4,toastId:e})},t);o.set(e,r)},[]);(0,s.useEffect)(()=>{if(a)return;let e=Date.now(),s=r.map(r=>{if(r.duration===1/0)return;let a=(r.duration||0)+r.pauseDuration-(e-r.createdAt);if(a<0){r.visible&&T.dismiss(r.id);return}return setTimeout(()=>T.dismiss(r.id,t),a)});return()=>{s.forEach(e=>e&&clearTimeout(e))}},[r,a,t]);let n=(0,s.useCallback)(O(t),[t]),l=(0,s.useCallback)(()=>{n({type:5,time:Date.now()})},[n]),d=(0,s.useCallback)((e,t)=>{n({type:1,toast:{id:e,height:t}})},[n]),c=(0,s.useCallback)(()=>{a&&n({type:6,time:Date.now()})},[a,n]),u=(0,s.useCallback)((e,t)=>{let{reverseOrder:a=!1,gutter:s=8,defaultPosition:o}=t||{},i=r.filter(t=>(t.position||o)===(e.position||o)&&t.height),n=i.findIndex(t=>t.id===e.id),l=i.filter((e,t)=>t<n&&e.visible).length;return i.filter(e=>e.visible).slice(...a?[l+1]:[0,l]).reduce((e,t)=>e+(t.height||0)+s,0)},[r]);return(0,s.useEffect)(()=>{r.forEach(e=>{if(e.dismissed)i(e.id,e.removeDelay);else{let t=o.get(e.id);t&&(clearTimeout(t),o.delete(e.id))}})},[r,i]),{toasts:r,handlers:{updateHeight:d,startPause:l,endPause:c,calculateOffset:u}}})(r,i);return s.createElement("div",{"data-rht-toaster":i||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:l,onMouseEnter:c.startPause,onMouseLeave:c.endPause},d.map(r=>{let i,n,l=r.position||t,d=c.calculateOffset(r,{reverseOrder:e,gutter:a,defaultPosition:t}),u=(i=l.includes("top"),n=l.includes("center")?{justifyContent:"center"}:l.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:v()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${d*(i?1:-1)}px)`,...i?{top:0}:{bottom:0},...n});return s.createElement(G,{id:r.id,key:r.id,onHeightUpdate:c.updateHeight,className:r.visible?J:"",style:u},"custom"===r.type?y(r.message,r):o?o(r):s.createElement(Z,{toast:r,position:l}))}))};e.s(["Toaster",()=>Q,"toast",()=>T],97483)},60037,e=>{"use strict";var t=e.i(96683),r=e.i(69103),a=e.i(78306),s=e.i(98980),o=e.i(32901),i=e.i(97483);function n(){let e=(0,a.useTranslations)("Tools.uuid-generator.ui"),[n,l]=(0,r.useState)([]),[d,c]=(0,r.useState)(1),[u,p]=(0,r.useState)("v4");return(0,t.jsxs)("div",{className:"max-w-3xl mx-auto space-y-6",children:[(0,t.jsx)(i.Toaster,{position:"bottom-right"}),(0,t.jsxs)(o.Card,{className:"p-6 space-y-6",children:[(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)("label",{className:"text-sm font-medium text-gray-700",children:e("quantity")}),(0,t.jsx)("input",{type:"number",min:"1",max:"1000",value:d,onChange:e=>c(Math.min(1e3,Math.max(1,parseInt(e.target.value)||1))),className:"w-full p-2 border border-gray-300 rounded-md"})]}),(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)("label",{className:"text-sm font-medium text-gray-700",children:e("version")}),(0,t.jsx)("select",{value:u,onChange:e=>p(e.target.value),className:"w-full p-2 border border-gray-300 rounded-md",disabled:!0,children:(0,t.jsx)("option",{value:"v4",children:e("v4")})})]})]}),(0,t.jsx)(s.Button,{onClick:()=>{let e=[];for(let t=0;t<d;t++)e.push(crypto.randomUUID());l(e)},className:"w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg",children:e("generate")})]}),n.length>0&&(0,t.jsxs)(o.Card,{className:"p-6 space-y-4",children:[(0,t.jsxs)("div",{className:"flex justify-between items-center",children:[(0,t.jsxs)("h3",{className:"font-medium text-gray-700",children:[e("generated")," (",n.length,")"]}),(0,t.jsxs)("div",{className:"flex gap-2",children:[(0,t.jsx)(s.Button,{onClick:()=>{l([])},variant:"ghost",size:"sm",className:"text-gray-500 hover:text-red-500",children:e("clear")}),(0,t.jsx)(s.Button,{onClick:()=>{navigator.clipboard.writeText(n.join("\n")),i.toast.success(e("copied"))},variant:"outline",size:"sm",children:e("copy")}),(0,t.jsx)(s.Button,{onClick:()=>{let e=new Blob([n.join("\n")],{type:"text/plain;charset=utf-8;"}),t=URL.createObjectURL(e),r=document.createElement("a");r.href=t,r.download=`uuids-${new Date().toISOString()}.txt`,r.click()},size:"sm",className:"bg-green-600 hover:bg-green-700 text-white",children:e("download")})]})]}),(0,t.jsx)("div",{className:"bg-gray-50 border border-gray-300 rounded-lg p-4 max-h-[400px] overflow-y-auto font-mono text-sm",children:n.map((e,r)=>(0,t.jsx)("div",{className:"py-1 border-b border-gray-200 last:border-0",children:e},r))})]})]})}e.s(["default",()=>n])}]);