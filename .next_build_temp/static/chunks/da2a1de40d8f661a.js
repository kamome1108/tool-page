...
to {
  ...
  animation: ${W} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,J=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(G,null,t):t:"blank"===r?null:s.createElement(_,null,s.createElement(M,{...a}),"loading"!==r&&s.createElement(H,null,"error"===r?s.createElement(z,{...a}):s.createElement(S,{...a})))},K=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
