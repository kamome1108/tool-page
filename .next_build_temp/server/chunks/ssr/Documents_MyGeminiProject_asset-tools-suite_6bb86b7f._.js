...
`,Z=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=((a,b="default")=>{let{toasts:c,pausedAt:d}=((a={},b=u)=>{let[c,d]=(0,e.useState)(y[b]||x),f=(0,e.useRef)(y[b]);(0,e.useEffect)(()=>(f.current!==y[b]&&d(y[b]),w.push([b,d]),()=>{let a=w.findIndex(([a])=>a===b);a>-1&&w.splice(a,1)}),[b]);let g=c.toasts.map(b=>{var c,d,e;return{...a,...a[b.type],...b,removeDelay:b.removeDelay||(null==(c=a[b.type])?void 0:c.removeDelay)||(null==a?void 0:a.removeDelay),duration:b.duration||(null==(d=a[b.type])?void 0:d.duration)||(null==a?void 0:a.duration)||C[b.type],style:{...a.style,...null==(e=a[b.type])?void 0:e.style,...b.style}}});return{...c,toasts:g}})(a,b),f=(0,e.useRef)(new Map).current,g=(0,e.useCallback)((a,b=F)=>{if(f.has(a))return;let c=setTimeout(()=>{f.delete(a),h({type:4,toastId:a})},b);f.set(a,c)},[]);(0,e.useEffect)(()=>{if(d)return;let a=Date.now(),e=c.map(c=>{if(c.duration===1/0)return;let d=(c.duration||0)+c.pauseDuration-(a-c.createdAt);if(d<0){c.visible&&E.dismiss(c.id);return}return setTimeout(()=>E.dismiss(c.id,b),d)});return()=>{e.forEach(a=>a&&clearTimeout(a))}},[c,d,b]);let h=(0,e.useCallback)(B(b),[b]),i=(0,e.useCallback)(()=>{h({type:5,time:Date.now()})},[h]),j=(0,e.useCallback)((a,b)=>{h({type:1,toast:{id:a,height:b}})},[h]),k=(0,e.useCallback)(()=>{d&&h({type:6,time:Date.now()})},[d,h]),l=(0,e.useCallback)((a,b)=>{let{reverseOrder:d=!1,gutter:e=8,defaultPosition:f}=b||{},g=c.filter(b=>(b.position||f)===(a.position||f)&&b.height),h=g.findIndex(b=>b.id===a.id),i=g.filter((a,b)=>b<h&&a.visible).length;return g.filter(a=>a.visible).slice(...d?[i+1]:[0,i]).reduce((a,b)=>a+(b.height||0)+e,0)},[c]);return(0,e.useEffect)(()=>{c.forEach(a=>{if(a.dismissed)g(a.id,a.removeDelay);else{let b=f.get(a.id);b&&(clearTimeout(b),f.delete(a.id))}})},[c,g]),{toasts:c,handlers:{updateHeight:j,startPause:i,endPause:k,calculateOffset:l}}})(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(X,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?Y:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(W,{toast:d,position:j}))}))};a.s(["Toaster",()=>Z,"toast",()=>E],31220)},2468,a=>{"use strict";var b=a.i(79903),c=a.i(349),d=a.i(5931),e=a.i(77089),f=a.i(2441),g=a.i(31220);function h(){let a=(0,d.useTranslations)("Tools.uuid-generator.ui"),[h,i]=(0,c.useState)([]),[j,k]=(0,c.useState)(1),[l,m]=(0,c.useState)("v4");return(0,b.jsxs)("div",{className:"max-w-3xl mx-auto space-y-6",children:[(0,b.jsx)(g.Toaster,{position:"bottom-right"}),(0,b.jsxs)(f.Card,{className:"p-6 space-y-6",children:[(0,b.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsx)("label",{className:"text-sm font-medium text-gray-700",children:a("quantity")}),(0,b.jsx)("input",{type:"number",min:"1",max:"1000",value:j,onChange:a=>k(Math.min(1e3,Math.max(1,parseInt(a.target.value)||1))),className:"w-full p-2 border border-gray-300 rounded-md"})]}),(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsx)("label",{className:"text-sm font-medium text-gray-700",children:a("version")}),(0,b.jsx)("select",{value:l,onChange:a=>m(a.target.value),className:"w-full p-2 border border-gray-300 rounded-md",disabled:!0,children:(0,b.jsx)("option",{value:"v4",children:a("v4")})})]})]}),(0,b.jsx)(e.Button,{onClick:()=>{let a=[];for(let b=0;b<j;b++)a.push(crypto.randomUUID());i(a)},className:"w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg",children:a("generate")})]}),h.length>0&&(0,b.jsxs)(f.Card,{className:"p-6 space-y-4",children:[(0,b.jsxs)("div",{className:"flex justify-between items-center",children:[(0,b.jsxs)("h3",{className:"font-medium text-gray-700",children:[a("generated")," (",h.length,")"]}),(0,b.jsxs)("div",{className:"flex gap-2",children:[(0,b.jsx)(e.Button,{onClick:()=>{i([])},variant:"ghost",size:"sm",className:"text-gray-500 hover:text-red-500",children:a("clear")}),(0,b.jsx)(e.Button,{onClick:()=>{navigator.clipboard.writeText(h.join("\n")),g.toast.success(a("copied"))},variant:"outline",size:"sm",children:a("copy")}),(0,b.jsx)(e.Button,{onClick:()=>{let a=new Blob([h.join("\n")],{type:"text/plain;charset=utf-8;"}),b=URL.createObjectURL(a),c=document.createElement("a");c.href=b,c.download=`uuids-${new Date().toISOString()}.txt`,c.click()},size:"sm",className:"bg-green-600 hover:bg-green-700 text-white",children:a("download")})]})]}),(0,b.jsx)("div",{className:"bg-gray-50 border border-gray-300 rounded-lg p-4 max-h-[400px] overflow-y-auto font-mono text-sm",children:h.map((a,c)=>(0,b.jsx)("div",{className:"py-1 border-b border-gray-200 last:border-0",children:a},c))})]})]})}a.s(["default",()=>h])}];

//# sourceMappingURL=Documents_MyGeminiProject_asset-tools-suite_6bb86b7f._.js.map